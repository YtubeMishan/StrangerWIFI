#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Modify History : rofl0r => Stranger => 🔰Rafiul Hasan Hridoy🔰 (Toxinum) (Hridoy)
# VERSION 🔰Rafiul Hasan Hridoy🔰
    ...
    def single_connection(self, bssid, pin=None, pixiemode=False, showpixiecmd=False,
        ...
        if store_pin_on_fail:
            try:
                ...
                print("\https://github.com/YtubeMishan/StrangerWIFI")
...
██╔════╝██╔══██╗████╗░██║░░░░░░░██║░░██╗░░██║██║██╔════╝█\n\t\t\033[1;36mRafiul-Hasan-Hridoy 
                                                    \n\t\t[\033[1;32m*\033[1;37m] NAME        : 🔰Rafiul Hasan Hridoy🔰\n\t\t[\033[1;32m*\033[1;37m] WORK ONLY   : GREEN-COLOR WIFI\n\t\t[\033[1;32m*\033[1;37m] AUTHOR      : Stranger \n\t\t[\033[1;32m*\033[1;37m] Version     : GENXes2.0 \n\t\t[\033[1;32m*\033[1;37m] FACEBOOK    : @Rafiul Hasan Hridoy \n''')
