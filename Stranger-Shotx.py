...
\033[1;31msudo python StrangerWIFI/Hridoy-Shotx.py-i wlan0 --iface-down -K
...
def usage():
    return """
GENXes 0.0.2 (c) 2017 rofl0r, modded by Rafiul-Hasan-Hridoy
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='GENXes 0.0.2 (c) 2017 rofl0r, modded by Rafiul-Hasan-Hridoy',
